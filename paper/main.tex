...
% \author{Jára Cimrman\refei{,}{vut} Zdeněk Svěrák, Petr Pavel}
\newcommand{\inst}{
...
\obr{fjfi.pdf}{Nejaky obrazek bez nepovinneho \uv{parametru}. Vypada trochu moc velky.}{fig:takakokotina}
...
\dobr{fjfi.pdf}{Jeden obrazek.}{fig:prvni}{symbol_cvut_konturova_verze_cb.pdf}{Druhý obr.}{fig:druhy}
