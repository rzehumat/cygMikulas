...
\begin{figure}[H]
    ...
    \begin{minipage}{0.24\textwidth}
        \centering
        \includegraphics[width=0.97\textwidth]{img/#1} % first figure itself
    \end{minipage}\hfill
    \begin{minipage}{0.24\textwidth}
        \centering
        \includegraphics[width=0.97\textwidth]{img/#2} % second figure itself
    \end{minipage}\hfill
    \begin{minipage}{0.24\textwidth}
        \centering
        \includegraphics[width=0.97\textwidth]{img/#3} % second figure itself
    \end{minipage}
    \begin{minipage}{0.24\textwidth}
        \centering
        \includegraphics[width=0.97\textwidth]{img/#4} % second figure itself
    \end{minipage}
\end{figure}
}
